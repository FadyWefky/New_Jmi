...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/deposit-fund/coinbase'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/coinbase.png" alt="BitPay"  class="max-width-100" />
                    <h3>CoinBase Funding Details</h3>
