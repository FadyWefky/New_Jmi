...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/deposit-fund/perfect-money'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="row" id="amount">
                      <label class="col-sm-4">Perfect Money Account:</label>
                      <div class="col-sm-8">
                          <div class="controls">
                              <input type="text" class="form-control" name="perfect_account" id="perfect_account" required />
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 ">
                        <div class="controls">
                             <input class="btn btn-success form-control" type="submit" value="Deposit Now" />
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/perfect.png" alt="Epay"  class="max-width-100" />
                    <h3>Perfect Money Funding Details</h3>
