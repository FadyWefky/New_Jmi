...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/withdraw-fund/perfect-money'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <br />
                <div class="row" id="perfect_account">          
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/perfect.png" alt="Perfect Money"  class="max-width-100" />
                    <h3>Perfect Money Withdrawing Details</h3>
