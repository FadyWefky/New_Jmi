       ...
       <div class="panel panel-default">
    	...
    	<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-xs-6 platform-box text-center">
				...
				<a href="https://download.mql5.com/cdn/web/jmi.brokers.ltd/mt4/jmibrokers4setup.exe" class="btn btn-success form-control">Download Now</a><br />
			...
			<div class="col-md-4 col-sm-4 col-xs-6 platform-box text-center">
				...
				<a href="https://download.mql5.com/cdn/mobile/mt4/ios?server=JMIBrokers-Demo,JMIBrokers-JMI" class="btn btn-success form-control">Download Now</a><br />
			...
			<div class="col-md-4 col-sm-4 col-xs-6 platform-box text-center">
				...
				<div class="box-details">Supported OS: Touchscreen smartphone or tablet, Android 2.1 and later</div>
				<a href="https://download.mql5.com/cdn/mobile/mt4/android?server=JMIBrokers-Demo,JMIBrokers-JMI" class="btn btn-success form-control">Download Now</a><br />
