...
@section('content')
    ...
    {!! Form::open(['url'=>'en/cpanel/withdraw-fund/epay'])  !!}
...
@if(count($accounts)>0)
            ...
            <div class="col-sm-6">
                ...
                <br />
                <div class="row" id="epay_account">          
                    <label class="col-sm-4">Epay Account </label>         
                    <div class="col-sm-8">
                        <div class="controls">
                            <input type="text" class="form-control" name="epay_account" id="epay_account" required />
            ...
            <div class="col-sm-5 col-sm-push-1" >
                ...
                <div id="demoaccount">
                <img loading="lazy" src="/assets/cpanel/img/epay.png" alt="Neteller"  class="max-width-100" />
                    <h3>Epay Withdrawing Details</h3>
