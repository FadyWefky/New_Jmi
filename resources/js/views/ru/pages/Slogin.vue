        ...
        <div class="container">
            ...
            <div class="bigDiv col-lg-3 col-sm-5 col-xs-6 col-xxs-12"  >
                ...
                <div class="login pdtb40">
                    ...
                    <p class="text-center">Forget<a href="/ru/forgot-password"> Password </a>?</p>
                    <p class="text-center">Don't have an account?<a href="/ru/signup"> Sign Up</a></p>
                </div>
            </div>
...
export default ({
    ...
    setup() {
        ...
        const handleLogin = async () => {
            ...
            try {
                const result = await axios.post('/ru/slogin', form)

                if (result.status === 200 && result.data) {
                    await router.push('/ru/spanel/home')
                }else if(result.status === 201){
                    $("#Error > span").text(result.data.errors.ru);
                    $("#Error").show();
                    $("#Success").hide();
                }
            } catch (e) {
